...
import {
    EBH_AUDIT_HANDLE_USER_EVENTS_FN,
    EBH_AUDIT_HANDLE_USER_EVENTS_HANDLER,
    SERVERLESS_EBH_AUDIT_SERVICE_NAME,
...
module.exports = {
    ...
    service: SERVERLESS_EBH_AUDIT_SERVICE_NAME,
    provider: {
    ...
    functions: {
        [EBH_AUDIT_HANDLE_USER_EVENTS_FN]: {
            handler: EBH_AUDIT_HANDLE_USER_EVENTS_HANDLER,
            events: [
                {
                    eventBridge: {
